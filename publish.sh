...
#   SERVER_URL - raw content host for the URL prefix (default raw.githubusercontent.com)
...
SERVER_URL="${SERVER_URL:-https://raw.githubusercontent.com}"
...
main() {
  ...
  # DEST_DIR was normalised at startup, so the path joins cleanly.
  local url_prefix="${SERVER_URL}/${GITHUB_REPOSITORY}/${RESULT_SHA}/${DEST_DIR}/"
